...
def sacar ():
    global saldo, contador_transacoes ,LIMITE_SAQUES
    try: # tratar  exceções 
        ...
        elif contador_transacoes >LIMITE_SAQUES : #Limite 3 saques por dia
...
while True :
    ...
    if escolha == 1 :
        ...
        # print ()
        # exibir_extrato()
        print (f'Exibir extrato : ' , extrato)
        print (f'Exibir extrato : {saldo:.2f}' )
    elif escolha == 4 : 
